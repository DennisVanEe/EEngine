...
std::string eeGames::ScriptEngine::dirParser(const std::string &dir)
{
	std::string name;
...
void eeGames::ScriptEngine::registerEngine()
{
	...
	RegisterScriptArray(_m_engine, true);
	RegisterScriptDictionary(_m_engine);
	RegisterScriptMath(_m_engine);

	error = _m_engine->SetDefaultNamespace("ee"); // the namespace all the following will fall under

	// register the standard functins
	error = _m_engine->RegisterGlobalFunction("void consolePrintln(const string &in)", asFUNCTION(consolePrintLine), asCALL_CDECL); assert(error >= 0);
	...
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, int8)", asMETHODPR(Request, add_int, (const std::string&, int8_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, int16)", asMETHODPR(Request, add_int, (const std::string&, int16_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, int32)", asMETHODPR(Request, add_int, (const std::string&, int32_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, int64)", asMETHODPR(Request, add_int, (const std::string&, int64_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, uint8)", asMETHODPR(Request, add_int, (const std::string&, uint8_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, uint16)", asMETHODPR(Request, add_int, (const std::string&, uint16_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, uint32)", asMETHODPR(Request, add_int, (const std::string&, uint32_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, uint64)", asMETHODPR(Request, add_int, (const std::string&, uint64_t), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, float)", asMETHODPR(Request, add_float, (const std::string&, float), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, double)", asMETHODPR(Request, add_float, (const std::string&, double), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool writeToDataCont(const string &in, const string &in, const string &in)", asMETHOD(Request, add_string), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);

	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, int8 &out)", asMETHODPR(Request, get_num, (const std::string&, int8_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, int16 &out)", asMETHODPR(Request, get_num, (const std::string&, int16_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, int32 &out)", asMETHODPR(Request, get_num, (const std::string&, int32_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, int64 &out)", asMETHODPR(Request, get_num, (const std::string&, int64_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, uint8 &out)", asMETHODPR(Request, get_num, (const std::string&, uint8_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, uint16 &out)", asMETHODPR(Request, get_num, (const std::string&, uint16_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, uint32 &out)", asMETHODPR(Request, get_num, (const std::string&, uint32_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, uint64 &out)", asMETHODPR(Request, get_num, (const std::string&, uint64_t*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, float &out)", asMETHODPR(Request, get_num, (const std::string&, float*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, double &out)", asMETHODPR(Request, get_num, (const std::string&, double*), bool), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool readFromDataCont(const string &in, const string &in, string &out)", asMETHOD(Request, get_string), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);

	error = _m_engine->RegisterGlobalFunction("bool terminateModule(const string &in)", asMETHOD(ScriptEngine, terminateModule), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool startModule(const string &in, const string &in)", asMETHOD(ScriptEngine, startModule), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool sleepModule(const string &in)", asMETHOD(ScriptEngine, sleepModule), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool wakeModule(const string &in)", asMETHOD(ScriptEngine, wakeModule), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);

	error = _m_engine->RegisterGlobalFunction("bool createDataConainter(const string &in)", asMETHOD(ScriptEngine, createDataContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool deleteDataContainer(const string &in)", asMETHOD(ScriptEngine, deleteDataContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool saveDataContainer(const string &in, const string &in)", asMETHOD(ScriptEngine, saveDataContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool loadDataContainer(const string &in, const string &in)", asMETHOD(ScriptEngine, loadDataContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);

	error = _m_engine->RegisterGlobalFunction("bool loadEntityContainer(const string &in)", asMETHOD(ScriptEngine, loadEntityContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);
	error = _m_engine->RegisterGlobalFunction("bool deleteEntityContainer(const string &in)", asMETHOD(ScriptEngine, deleteEntityContainer), asCALL_THISCALL_ASGLOBAL, this); assert(error >= 0);

	// register enums for keyboard and mouse presses:
	error = _m_engine->RegisterEnum("Mouse"); assert(error >= 0);
	error = _m_engine->RegisterEnumValue("Mouse", "Left", 0); assert(error >= 0);
	error = _m_engine->RegisterEnumValue("Mouse", "Right", 1); assert(error >= 0);
	error = _m_engine->RegisterEnumValue("Mouse", "Middle", 2); assert(error >= 0);
	error = _m_engine->RegisterEnumValue("Mouse", "XButton1", 3); assert(error >= 0);
	error = _m_engine->RegisterEnumValue("Mouse", "XButton2", 4); assert(error >= 0);
	...
	error = _m_engine->RegisterGlobalFunction("bool isButtonPressed(Mouse)", asFUNCTION(isButtonPressed), asCALL_CDECL); assert(error >= 0);
	...
	error = _m_engine->RegisterObjectType("AnimatedEntity", sizeof(AnimatedEntity), asOBJ_VALUE | asOBJ_POD); assert(error >= 0);
	error = _m_engine->RegisterObjectBehaviour("AnimatedEntity", asBEHAVE_CONSTRUCT, "void f(const string &in, const string &in)", asMETHOD(RenderEngine, animatedEntityConst), asCALL_THISCALL_OBJLAST, _m_renderEngine); assert(error >= 0);
	error = _m_engine->RegisterObjectBehaviour("AnimatedEntity", asBEHAVE_DESTRUCT, "void f()", asMETHOD(RenderEngine, animatedEntityDest), asCALL_THISCALL_OBJLAST, _m_renderEngine); assert(error >= 0);
	...
	// rendering
	error = _m_engine->RegisterObjectMethod("AnimatedEntity", "void setRenderLevel(int)", asMETHOD(AnimatedEntity, setRenderLevel), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("AnimatedEntity", "int getRenderLevel(int)", asMETHOD(AnimatedEntity, getRenderLevel), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("AnimatedEntity", "void setVisible(bool)", asMETHOD(AnimatedEntity, setVisible), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("AnimatedEntity", "bool isVisible()", asMETHOD(AnimatedEntity, isVisible), asCALL_THISCALL); assert(error >= 0);

	// register StaticEntity creation and functions
	error = _m_engine->RegisterObjectType("StaticEntity", sizeof(StaticEntity), asOBJ_VALUE | asOBJ_POD); assert(error >= 0);
	error = _m_engine->RegisterObjectBehaviour("StaticEntity", asBEHAVE_CONSTRUCT, "void f(const string &in, const string &in)", asMETHOD(RenderEngine, staticEntityConst), asCALL_THISCALL_OBJLAST, _m_renderEngine); assert(error >= 0);
	error = _m_engine->RegisterObjectBehaviour("StaticEntity", asBEHAVE_DESTRUCT, "void f()", asMETHOD(RenderEngine, staticEntityDest), asCALL_THISCALL_OBJLAST, _m_renderEngine); assert(error >= 0);
	...
	// rendering
	error = _m_engine->RegisterObjectMethod("StaticEntity", "void setRenderLevel(int)", asMETHOD(StaticEntity, setRenderLevel), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("StaticEntity", "int getRenderLevel(int)", asMETHOD(StaticEntity, getRenderLevel), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("StaticEntity", "void setVisible(bool)", asMETHOD(StaticEntity, setVisible), asCALL_THISCALL); assert(error >= 0);
	error = _m_engine->RegisterObjectMethod("StaticEntity", "bool isVisible()", asMETHOD(StaticEntity, isVisible), asCALL_THISCALL); assert(error >= 0);
	...
	error = _m_engine->RegisterObjectMethod("Music", "void setVolume(uint8)", asMETHOD(SoundMusic, setVolume), asCALL_THISCALL); assert(error >= 0);
...
{
	m_scriptBuilder.StartNewModule(_m_engine, dirParser(dir).c_str());
	int error = m_scriptBuilder.AddSectionFromFile(dir.c_str());
	if (error < 0)
	{
		std::cout << "could not find or open the file at " << dir << "\n";
		return false;
	}
	...
	if (error < 0)
	{
		std::cout << "could not build the module at " << dir << "\n";
		return false;
	}
	...
	temp->setSleep(true);
	m_commands.push_back(std::make_pair(CommandType::M_WAKE, temp.get()));
	_m_currentModuleList.insert(std::make_pair(id, std::move(temp)));
	return true;
}

bool eeGames::ScriptEngine::terminateModule(const std::string &id)
{
	auto it = _m_currentModuleList.find(id);
	if (it == _m_currentModuleList.end())
		return false;

	m_commands.push_back(std::make_pair(CommandType::M_TERM, it->second.get()));
	return true;
...
bool eeGames::ScriptEngine::sleepModule(const std::string &_p_name)
{
	...
	m_commands.push_back(std::make_pair(CommandType::M_SLEEP, it->second.get()));
	return true;
...
bool eeGames::ScriptEngine::wakeModule(const std::string &_p_name)
{
	...
	m_commands.push_back(std::make_pair(CommandType::M_WAKE, it->second.get()));
	return true;
...
{
	return _m_dataContainerEngine->add_container(id);
}

bool eeGames::ScriptEngine::deleteDataContainer(const std::string &id)
{
	return _m_dataContainerEngine->remove_container(id);
}

bool eeGames::ScriptEngine::saveDataContainer(const std::string &id, const std::string &dir)
{
	return _m_dataContainerEngine->save_container(id, dir);
}

bool eeGames::ScriptEngine::loadDataContainer(const std::string &id, const std::string &dir)
{
	return _m_dataContainerEngine->load_container(id, dir);
}

bool eeGames::ScriptEngine::loadEntityContainer(const std::string &dir)
{
	return _m_entityContainerEngine->loadContainer(dir);
}
